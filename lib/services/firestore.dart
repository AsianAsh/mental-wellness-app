...
class FirestoreService {
  ...
  Future<void> updateLastActive() async {
    ...
    if (currentUser != null) {
      ...
      if (memberDocSnapshot.exists) {
        ...
        print(
            "Document does not exist for both Member and Counsellor. Creating new document in Members collection...");
  ...
  // Other methods, e.g., createCounsellorDocument, createUserDocument, etc.
  Future<void> createCounsellorDocument(UserCredential userCredential) async {
    if (userCredential != null && userCredential.user != null) {
      await _firestore
          .collection("counsellors")
        ...
        'firstName': '', // Add other fields as needed
        'lastName': '',
        'bio': '',
        'qualifications': '',
        'location': '',
